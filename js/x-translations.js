(function(angular) {
	...
	.config(['$translateProvider', function($translateProvider) {
		...
		$translateProvider.translations('sk', {
			...
			"schema.people.player":"Pretekár",
			"schema.people.isPlayer":"Je pretekár",
			...
			"schema.people.delegate":"Delegát",
			"schema.people.isDelegate":"Je delegát",
			"schema.people.delegate.stateOfDelegate":"Stav delegáta",
			...
			"schema.people.referee.refereeLicense":"Číslo licencie",
			"schema.people.referee.refereeLicenseType":"Typ licencie",
			...
			"schema.people.coach.coachLicenseLevel":"Úroveň licencie",
			...
			"schema.people.medic.dateOfRegistration":"Dátum registrácie",
			...
			"schema.people.statistic.dateOfRegistration":"Dátum registrácie",
			...
			"schema.people.additionalInfo":"Doplňujúce údaje",
			"schema.people.additionalInfo.discipline":"Disciplína",
			"schema.people.additionalInfo.discipline.match":"Zápas - olympijská",
			"schema.people.additionalInfo.discipline.poomsae":"POOMSAE - neolympijská",
			"schema.people.additionalInfo.representative":"Reprezentant",
			"schema.people.additionalInfo.representative.club":"Klubový",
			"schema.people.additionalInfo.discipline.association":"Zväzový",
			...
			"schema.stadium.length":"Dĺžka (m)",
			"schema.stadium.width":"Šírka (m)",
			"schema.stadium.height":"Výška (m)",
			...
			"schema.stadium.surface.taraflex":"Taraflex",
			"schema.stadium.surface.artificial":"Palubovka",

			"schema.club.title":"Klub",
			"schema.org.club.codeOfClub":"Kód klubu",
			"schema.org.club.businessName":"Obchodný názov spoločnosti",
			...
			"schema.org.club.contactAdress":"Kontaktná osoba - poštová adresa",
			...
			"schema.org.club.mailOfContactPerson":"Mail kontaktnej osoby",
			"schema.org.club.street":"Ulica",
			"schema.org.club.houseNumber":"Číslo domu",
			"schema.org.club.zipCode":"PSČ",
			"schema.org.club.region":"Kraj",
			"schema.org.club.webSite":"Web stránka",
			"schema.org.club.clubMail":"Mail na klub",
			...
			"schema.org.bankInfo.regNumber":"Číslo reg. na MV SR",
			...
			"schema.transfer.dateFrom":"Začiatok prestup/hosťovanie",
			...
			"schema.roster.teamManager":"Manažér družstva",
			"schema.roster.stadium":"Štadión",
			...
			"schema.roster.statisticians":"Štatistici",
			"schema.roster.statistics":"Štatistik",
			"schema.roster.medics":"Zdravotníci",
			"schema.roster.medic":"Zdravotník",
			...
			"schema.competitionPart.typeOfCompetition.manual":"Manuálne",
			"schema.competitionPart.typeOfCompetition.berger-base":"Základný berger",
			"schema.competitionPart.typeOfCompetition.berger-same-pair-twice":"Berger-každé stretnutie 2krát",
			"schema.competitionPart.countOfMatches":"Počet stretnutí",
			"schema.competitionPart.matchIDForNotPlayingTeam":"Číslovať volné stretnutie?",
			"schema.competitionPart.matchIDNullBeforeSecondHalf":"Vynulovať počítadlo stretnutí pred odvetnou časťou?",
			"schema.competitionPart.competitionModel":"Model súťaže",
			...
			"schema.refereeReport.baseData.season":"Súťažný ročník",
			...
			"schema.refereeReport.baseData.countOfBalls":"Počet lôpt",
			"schema.refereeReport.baseData.contumacy":"Kontumácia",
			...
			"schema.refereeReport.genBerger.notPlaying.team":"Nehrajúce družstvo:",
			...
			"schema.refereeReport.baseData.state":"Stav",
			"schema.refereeReport.baseData.matchNumber":"Číslo stretnutia",
			...
			"schema.refereeReport.officers.officerA":"ZVD",
			"schema.refereeReport.officers.officerB":"Tréner",
			"schema.refereeReport.officers.officerC":"Funkcionár",
			"schema.refereeReport.officers.officerD":"Funkcionár",
			...
			"schema.refereeReport.listOfPlayers.dressNumber":"Číslo dresu",
			"schema.refereeReport.listOfPlayers.player":"Hráč",
			"schema.refereeReport.listOfPlayers.altName":"Alternatívne meno",
			...
			"schema.requests.basedata.status.rejected":"Zamietnutá",
			"schema.requests.basedata.status.processing":"Spracovávaná",
			"schema.requests.basedata.status.closed":"Uzavretá",
			"schema.requests.basedata.status.canceled":"Stornovaná",
			...
			"schema.requests.file":"Zoznam súborov",
		...
		$translateProvider.translations('cz', {
			...
			"schema.competitionPart.typeOfCompetition.berger-same-pair-twice":"Berger-každé stretnutie 2krát",
			"schema.competitionPart.countOfMatches":"Počet stretnutí",
			"schema.competitionPart.matchIDForNotPlayingTeam":"Číslovať volný stretnutie?",
			"schema.competitionPart.matchIDNullBeforeSecondHalf":"Vynulovať počítadlo stretnutí pred odvetnou časťou?",
			"schema.competitionPart.competitionModel":"Model súťaže",
			"schema.competitionPart.competitionModel.model-1":"Na 3 víťazné sety s hodnotením 3,2,1,0,-1",
			"schema.competitionPart.competitionModel.model-2":"Na 2 víťazné sety s hodnotením 3,2,1,0,-1",
			...
			"schema.refereeReport.baseData.fullTimeScoreAway":"Výsledok hostia",
			"schema.refereeReport.baseData.countOfBalls":"Počet lôpt",
			"schema.refereeReport.baseData.contumacy":"Kontumace",
			"schema.refereeReport.baseData.matchBegin":"Začiatok stretnutia",
			"schema.refereeReport.baseData.attendance":"Návštevnosť",
			"schema.refereeReport.baseData.stadium":"Štadion",
			"schema.refereeReport.genBerger.notPlaying.team":"Nehrajúce družstvo:",
